...
public class DataIntegrityTest extends BaseDatabaseTest {
    ...
    void testCheckConstraint_DueDateAfterBorrowDate() throws SQLException {
        ...
        logger.info("TC307 PASSED: CHECK constraint for due_date > borrow_date working correctly");
    }
    ...
    void testCheckConstraint_AvailableCopiesLessThanOrEqualToTotal() {
        ...
        logger.info("TC308 PASSED: CHECK constraint check_available_copies working correctly");
    }
    ...
    void testCheckConstraint_ValidUserRole() {
        ...
        logger.info("TC309 PASSED: CHECK constraint for user role working correctly");
    }

    @Test
    @Order(9)
    @DisplayName("TC39: CHECK Constraint - Book status must be valid enum value")
    void testCheckConstraint_ValidBookStatus() throws SQLException {
        ...
        logger.info("TC310 PASSED: CHECK constraint for book status working correctly");
    }
    ...
    void testCheckConstraint_ValidPublicationYear() {
        ...
        logger.info("TC311 PASSED: CHECK constraint for publication year working correctly");
    }
    ...
    void testUniqueConstraint_DuplicateUsername() throws SQLException {
        ...
        logger.info("TC315 PASSED: UNIQUE constraint for username working correctly");
    }
    ...
    void testUniqueConstraint_DuplicateEmail() throws SQLException {
        ...
        logger.info("TC316 PASSED: UNIQUE constraint for email working correctly");
    }
    ...
    void testUniqueConstraint_DuplicateIsbn() throws SQLException {
        ...
        logger.info("TC317 PASSED: UNIQUE constraint for ISBN working correctly");
    }
    ...
    void testNotNullConstraint_UsernameCannotBeNull() {
        ...
        logger.info("TC319 PASSED: NOT NULL constraint for username working correctly");
    }
    ...
    void testNotNullConstraint_EmailCannotBeNull() {
        ...
        logger.info("TC320 PASSED: NOT NULL constraint for email working correctly");
    }
    ...
    void testNotNullConstraint_BookTitleCannotBeNull() {
        ...
        logger.info("TC321 PASSED: NOT NULL constraint for book title working correctly");
    }

    @Test
    @Order(17)
    @DisplayName("TC322: NOT NULL Constraint - Book ISBN cannot be null")
    void testNotNullConstraint_BookIsbnCannotBeNull() {
        ...
        logger.info("TC322 PASSED: NOT NULL constraint for book ISBN working correctly");
    }
    ...
    void testTrigger_UpdatedAtAutoUpdateOnUserUpdate() throws SQLException, InterruptedException {
        ...
        logger.info("TC326 PASSED: Trigger updated_at working correctly for users");
    ...
    @Test
    @Order(19)
    @DisplayName("TC327: Trigger - updated_at auto-update on book update")
    void testTrigger_UpdatedAtAutoUpdateOnBookUpdate() throws SQLException, InterruptedException {
        ...
        // ACT - Update book available copies
        ...
        logger.info("TC327 PASSED: Trigger updated_at working correctly for books");
    }
    ...
    void testComplexConstraint_MultipleBorrowingsSameBookDifferentUsers() throws SQLException {
        ...
        logger.info("TC329 PASSED: Multiple borrowings of same book allowed for different users");
